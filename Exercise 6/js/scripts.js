...
const pages = {
    ...
    exercise6: `
        <section class="content-section">
            <h1>Exercise 6 - Interactive Histogram</h1>

            <p class="intro-text">
                This section uses D3 to create an interactive histogram of TV energy consumption.
                Users can filter the histogram by screen technology and screen size.
            </p>

            <div class="story-card">
                <h2>Energy Consumption for Different TV Screen Types and Sizes</h2>

                <p>
                    The histogram shows the frequency distribution of labelled TV energy consumption.
                    The buttons below allow the data to be filtered by screen technology and selected screen sizes.
                </p>

                <h3>Filter by Screen Technology</h3>
                <div id="filters_screen" class="filter-row"></div>

                <div id="histogram" class="responsive-svg-container"></div>

                <h3>Filter by Screen Size</h3>
                <div id="filters_size" class="filter-row"></div>
